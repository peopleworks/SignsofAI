...
public static class ReportMessages
{
    ...
    public static IReadOnlyDictionary<string, string> Defaults { get; } = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [CaveatLanguageMeasured] = "> **A score is not proof.** On {0} texts in this language, published before generative models existed, this build's false-positive rate at a threshold of {1}/100 was under {2} — the upper end of a 95% interval, not a guarantee, and measured on published articles and essays by adult learners of English, not on this writer's work. Below that threshold, treat the score as saying nothing.",
        [CaveatAggregateMeasured] = "> **A score is not proof.** On {0} texts published before generative models existed, this build's false-positive rate at a threshold of {1}/100 was under {2} — the upper end of a 95% interval, not a guarantee, and measured on published articles and essays by adult learners of English, not on this writer's work. Below that threshold, treat the score as saying nothing.",

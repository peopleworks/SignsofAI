...
public static class ReportMessages
{
    ...
    public static IReadOnlyDictionary<string, string> Defaults { get; } = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [CaveatAggregateNoThreshold] = "> **No threshold is supported yet.** This build was measured against {0} texts, too few to bound its false-positive rate with any precision, so no score on this page should be used to support a decision about a person.",
        ...
        [CaveatLanguageNoThreshold] = "> **No threshold is supported for this language yet.** The corpus holds {0} texts in it — too few to bound with any precision how often this build is wrong about writing in it, so no score on this page should be used to support a decision about a person. The best bound these texts support is {1}, and the overall figure is not a substitute for it.",
        [CaveatLanguageMeasured] = "> **A score is not proof.** On {0} texts in this language, from before 2022, this build's false-positive rate at a threshold of {1}/100 was under {2} — the upper end of a 95% interval, not a guarantee, and measured on published articles and encyclopedia revisions and on essays by adult learners of English, not on this writer's work. Below that threshold, treat the score as saying nothing.",
        [CaveatAggregateMeasured] = "> **A score is not proof.** On {0} texts from before 2022, this build's false-positive rate at a threshold of {1}/100 was under {2} — the upper end of a 95% interval, not a guarantee, and measured on published articles and encyclopedia revisions in both languages and on essays by adult learners of English, not on this writer's work. Below that threshold, treat the score as saying nothing.",
        ...
        [ObservationsIntro] = "Measured against writing from before 2022. Shown because they are real, and counted for nothing because they are ordinary.",
        ...
        [HowLanguageNoThreshold] = "Measured against **{0} texts in this language**, from before 2022, on {2} with engine {3}. That sample is too small to support a threshold; the best upper bound it supports is **{1}**, and the overall figure is not a substitute.",
        [HowLanguageMeasured] = "Measured against **{0} texts in this language**, from before 2022, on {3} with engine {4}. At **{1}/100**, the upper end of the measured 95% false-positive interval was **{2}** — an interval, not a guarantee.",
        [HowAggregateIntro] = "Measured against **{0} texts from before 2022**, so their authorship rests on their dates rather than on anybody's judgement. Measured on {1} with engine {2}.",
